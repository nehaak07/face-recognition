...
button1 = tk.Button(root, text="Detect in Photo", command=lambda: picture('images/person.jpg'))
button2 = tk.Button(root, text="Detect an object", command=lambda: picture('images/bottle.jpg'))
button3 = tk.Button(root, text="Detect in Group Pic", command=lambda: picture('images/group.jpg'))
